...
export class MainDialog extends RouterDialog {
    ...
    constructor(
        ...
        skillMode: boolean) {
            ...
            this.conversationStateAccessor = conversationState.createProperty(<%=skillConversationStateNameClass%>.name);
            this.userStateAccessor = userState.createProperty(<%=skillUserStateNameClass%>.name);
