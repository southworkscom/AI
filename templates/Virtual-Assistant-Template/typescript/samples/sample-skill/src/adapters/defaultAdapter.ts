    ...
    public constructor(
        ...
        this.onTurnError = async (context: TurnContext, error: Error): Promise<void> => {
            ...
            if (context.isSkill()){
                ...
                // The createEndOfConversationActivity() method is not available on botbuilder-js
                // Uncomment this when the method be migrated to js.
                // const endOfconversation = Activity.createEndOfConversationActivity();
