...
namespace BotTemplatesVSIX.Test
{
    ...
    public class GeneratorVirtualAssistantTest
    {
        private readonly ITestOutputHelper output;
        private readonly string _vaProjectTemplatePath = @"..\..\..\..\VA\VA\VAProjectTemplate.vstemplate";

        public GeneratorVirtualAssistantTest(ITestOutputHelper output)
        {
            this.output = output;
        }

        [VsFact]
        public void Test_Generator_VA_Template()
        {
            ...
            output.WriteLine("The generator Bot Virtual Assistant template");
