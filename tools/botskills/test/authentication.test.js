...
describe("The authentication util", function() {
    ...
    describe("should show a warning", function() {
        ...
        it("when the skill manifest doesn't contain an Azure Active Directory v2 as authentication connection", async function() {
            const configuration = {
                botName: "",
                localManifest: resolve(__dirname, join("mocks", "skillsV1", "googleAuthenticationManifest.json")),
                remoteManifest: "",
                dispatchName: "",
                language: "",
                luisFolder: "",
...
https://aka.ms/vamanualauthsteps`);
        ...
        it("when any of the external commands fails", async function() {
            const configuration = {
                botName: "",
                localManifest: resolve(__dirname, join("mocks", "skillsV1", "azureActiveDirectoryV2AuthenticationManifest.json")),
                remoteManifest: "",
                dispatchName: "",
                language: "",
                luisFolder: "",
...
https://aka.ms/vamanualauthsteps`);
        ...
        it("when any scope is not recognized", async function () {
            ...
            const configuration = {
                botName: "testScope",
                localManifest: resolve(__dirname, join("mocks", "skillsV1", "unrecognizedScopesManifest.json")),
                remoteManifest: "",
                dispatchName: "",
                language: "",
                luisFolder: "",
    ...
    describe("should not show a warning", function() {
        it("when the scopes property doesn't exist in the authenticationConnections", async function () {
            const configuration = {
                botName: "testScope",
                localManifest: resolve(__dirname, join("mocks", "skillsV1", "noScopesPropertyManifest.json")),
                remoteManifest: "",
                dispatchName: "",
                language: "",
                luisFolder: "",
        ...
        it("when the scopes property contains empty strings", async function () {
            const configuration = {
                botName: "testScope",
                localManifest: resolve(__dirname, join("mocks", "skillsV1", "emptyScopesManifest.json")),
                remoteManifest: "",
                dispatchName: "",
                language: "",
                luisFolder: "",
        ...
        it("when all the scopes are recognized", async function () {
            const configuration = {
                botName: "testScope",
                localManifest: resolve(__dirname, join("mocks", "skillsV1", "recognizedScopesManifest.json")),
                remoteManifest: "",
                dispatchName: "",
                language: "",
                luisFolder: "",
